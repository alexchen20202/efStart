...
{
    public class DepartmentsRawVersionController : Controller
    {
        private readonly SchoolContext _context;

        public DepartmentsRawVersionController(SchoolContext context)
        {
            _context = context;
        }

        // GET: DepartmentsRawVersion
        ...
        // GET: DepartmentsRawVersion/Details/5
        ...
        // GET: DepartmentsRawVersion/Create
        ...
        // POST: DepartmentsRawVersion/Create
        ...
        // GET: DepartmentsRawVersion/Edit/5
        ...
        // POST: DepartmentsRawVersion/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        // [HttpPost]
        // [ValidateAntiForgeryToken]
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            await _context.Departments.Include(i => i.Administrator).FirstOrDefaultAsync(m => m.DepartmentID == id);
        ...
        // GET: DepartmentsRawVersion/Delete/5
        ...
        // POST: DepartmentsRawVersion/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
